...
func (q *query) paneVars() *query {
	return q.vars(
		...
		varPaneUnzoomedHeight,
		varPaneUnzoomedWidth,
		varPaneWidth,
		varPaneWindowIndex,
		varPaneX,
		varPaneY,
...
func (r queryResult) toPane(t *Tmux) *Pane {
	return &Pane{
		...
		Fg:             r.get(varPaneFg),
		Flags:          r.get(varPaneFlags),
		FloatingFlag:   isOne(r.get(varPaneFloatingFlag)),
		...
		ModalFlag:      isOne(r.get(varPaneModalFlag)),
		...
		UnzoomedHeight: atoi(r.get(varPaneUnzoomedHeight)),
		UnzoomedWidth:  atoi(r.get(varPaneUnzoomedWidth)),
		Width:          atoi(r.get(varPaneWidth)),
		WindowIndex:    atoi(r.get(varPaneWindowIndex)),
		X:              atoi(r.get(varPaneX)),
		Y:              atoi(r.get(varPaneY)),
		Z:              atoi(r.get(varPaneZ)),
		tmux:           t,
	}
}
